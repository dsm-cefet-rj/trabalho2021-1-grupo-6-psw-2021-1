...
import ConsultaAgendada from'../utils/ConsultaAgendada';
import LogoRodape from '../utils/LogoRodape';
  ...
  render() {
    return (
      <div class="container-sm">
        ...
        */}
        <ConsultaAgendada titulo="Consultas agendadas" />
        {/*
        <form class="row g-3">
